...
object HttpChaos {
  ...
  object Target {
    ...
    final case class Response(
      ...
      /**
       * Specifies match by the status code responded by target. By default takes effect for all
       * status codes
       */
      ...
      /**
       * Specifies match by headers in response from target. Takes effect for all responses by
       * default
       */
  ...
  private[chaosmesh] final case class RequestReplace(
    path: Option[String] = None,
    method: Option[String] = None,
    queries: Option[NonEmptyMap[String, String]] = None,
  )

  private[chaosmesh] final case class ResponseReplace(
    code: Option[Int] = None,
  )

  private[chaosmesh] final case class Body(
    `type`: Option[String] = None,
    value: Option[String] = None,
  )

  private[chaosmesh] final case class RequestPatch(
